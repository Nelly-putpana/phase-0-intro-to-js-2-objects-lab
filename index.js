...
const employee = {name: "Nelly", streetAddress: "Apple street",};
...
function deleteFromEmployeeByKey (employee, key) {const newEmployee = {... employee[key]}; 
delete newEmployee [key]; return newEmployee;};
